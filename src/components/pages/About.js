    ...
    return (
        <section className="bg-gradient-to-b from-slate-700 to-neutral-50 text-slate px-5 py-32">
            <div className="container mx-auto grid md:grid-cols-2 items-center justify-center md:justify-between">
                ...
                <div>
                    <img className='rounded-full m-10 p-10 blur-sm transition ease-in-out hover:blur-none hover:drop-shadow-2xl hover:rotate-[17deg] ' src='../../images/Profile.png' alt='image of person who made this site'></img>
                </div>
            </div>
        </section>
    )
