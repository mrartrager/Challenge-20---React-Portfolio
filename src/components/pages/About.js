        ...
        <section className="bg-gradient-to-b from-slate-700 to-neutral-50 text-slate px-5 py-32">
            <div className="container mx-auto grid md:grid-cols-2 items-center justify-center md:justify-between">
                <div className="about-info bg-gray-200 p-5 shadow-2xl rounded-2xl border-double border-4 border-sky-500">
                    <h1 className="text-4xl font-bold m-5 mb-5 border-b-[5px] w-[180px] border-indigo-600 pb-2">
                        About Me
                    </h1>

                    <p className="font-normal text-2xl m-5 pb-5">
                    ...
                    <p className="text-2xl pb-5">
                        <h2 className="text-4xl font-bold mb-5 border-b-[5px] w-[180px] border-indigo-600 m-5 pb-2 flex justify-items-center justify-cente">Summary</h2>
                        <ul className="flex flex-wrap p-5 m-5">
                            <li className="p-2 m-5 hover:drop-shadow-lg hover:text-amber-700 font-bold cursor-pointer">REACT</li>
                            <li className="p-2 m-5 hover:drop-shadow-lg hover:text-lime-700 font-bold cursor-pointer">Tailwind</li>
                            <li className="p-2 m-5 hover:drop-shadow-lg hover:text-cyan-500 font-bold cursor-pointer">BootStrap</li>
                            <li className="p-2 m-5 hover:drop-shadow-lg hover:text-violet-500 font-bold cursor-pointer">NodeJs</li>
                            <li className="p-2 m-5 hover:drop-shadow-lg hover:text-rose-400 font-bold cursor-pointer">Express</li>
                            <li className="p-2 m-5 hover:drop-shadow-lg hover:text-emerald-500 font-bold cursor-pointer">MySQL</li>
                            <li className="p-2 m-5 hover:drop-shadow-lg hover:text-purple-600 font-bold cursor-pointer">MongoDB</li>
                            <li className="p-2 m-5 hover:drop-shadow-lg hover:text-red-500 font-bold cursor-pointer">Mongoose</li>
                        </ul>
                    </p>
                </div>
                <div>
